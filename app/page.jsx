  ...
  return (
    <>
      <div>
        ...
        <section id='grid' className='grid grid-cols-4 lg:grid-cols-6 grid-rows-4 gap-3 *:rounded-sm *:overflow-hidden *:bg-zinc-950'>
          {/* Row 1 */}
          <div className='col-span-4 lg:col-span-2 flex items-center justify-center'><p className='text-8xl font-black'>ARKiva</p></div>
          <div className='single-row col-span-2 lg:col-span-1 flex items-center justify-center'><LuPaintbrush className='w-32 h-32 stroke-1' /></div>
          <div className='single-row col-span-2 lg:col-span-1 flex items-center justify-center'><AnimatedTriangle /></div>
          ...
          <div className='relative col-span-3 lg:col-span-1 row-span-2 flex flex-col justify-between p-4'>
          ...
          {/* Row 2 */}
          <div className='relative col-span-4 lg:col-span-2 row-span-2 p-4 h-full'>
          ...
          <div className='relative col-span-4 lg:col-span-2 row-span-2 p-4'>
          ...
          <div className='col-span-4 lg:col-span-2 flex flex-col justify-center items-start p-4 gap-4'>
